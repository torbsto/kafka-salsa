...
public class EdgeProcessor extends AbstractProcessor<byte[], Edge> {
    ...
    public void init(ProcessorContext processorContext) {
        ...
        leftIndex = (KeyValueStore<Long, AdjacencyList>) processorContext.getStateStore(BaseKafkaSalsaApp.LEFT_INDEX_NAME);
        rightIndex = (KeyValueStore<Long, AdjacencyList>) processorContext.getStateStore(BaseKafkaSalsaApp.RIGHT_INDEX_NAME);
    }
